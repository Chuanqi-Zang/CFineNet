...
#         self.data_root = data_root + '/preprocess160120'
...
#             self.persons = list(range(1, 20))
#             self.ite_len=500
#         else:
#             self.train = False
#             self.persons = list(range(20, 26))
#             self.data_type = 'test'
#             self.ite_len=1000
#         self.dirs= []
...
#             self.dirs.append(p)
#         self.seed_set = False
#         print("success load ucf-101, data len: %d"%self.data_len)
#
...
class UCF(object):
    ...
    def __init__(self, train, data_root, n_frames_input=8, n_frames_output=10, image_size=(88, 64)):

        self.n_input = n_frames_input
        # self.n_output = n_frames_output
        self.seq_len = n_frames_input+n_frames_output
        self.image_size = image_size
        if self.image_size == (120, 160):
            self.data_len = 0
            self.data_root = data_root + '/preprocess160120'
            self.classes = os.listdir(self.data_root)
            if train:
