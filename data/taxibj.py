...
class Taxibj(object):
    def __init__(self, train, data_root, n_frames_input=10, n_frames_output=10, image_size=(32, 32)):
        self.train = train
    ...
    def get_sequence(self):
        if self.train:
            ...
            seq = np.array(self.train_data[index])
        else:
            index = random.choice(self.test_indices)
            seq = np.array(self.test_data[index])
